...
public class SPAdjectiveSlot extends SPSlot {
    ...
    public SPAdjectiveSlot(IRI leIRI, String cas, String gen, String num, NodeID agreeID, NodeID id, int o) {
        super(id, o);
    ...
    public SPAdjectiveSlot(SPAdjectiveSlot o) {
